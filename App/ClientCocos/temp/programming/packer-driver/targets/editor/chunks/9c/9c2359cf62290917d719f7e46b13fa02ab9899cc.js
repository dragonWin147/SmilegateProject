System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, EditBox, Label, log, Node, SocketHandler, LobbyText, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _class3, _crd, ccclass, property, GameController;
      ...
      _export("GameController", GameController = (_dec = ccclass('GameController'), _dec2 = property(EditBox), _dec3 = property(EditBox), _dec4 = property(Label), _dec5 = property(Label), _dec6 = property(Node), _dec7 = property(Node), _dec(_class = (_class2 = (_class3 = class GameController extends Component {
        ...
        resultPlayGame(dataPlay) {
          ...
          if (dataPlay.errorCode == 0) {
            this.lbName.string = dataPlay.username;
          } else {
...
//# sourceMappingURL=9c2359cf62290917d719f7e46b13fa02ab9899cc.js.map