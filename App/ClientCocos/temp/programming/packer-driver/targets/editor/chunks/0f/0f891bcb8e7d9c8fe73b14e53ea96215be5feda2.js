System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, GameController, DataLogin, DataPlayGame, _dec, _class, _class2, _crd, ccclass, property, METHOD, SocketHandler;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("DataPlayGame", DataPlayGame = class DataPlayGame {
        constructor() {
          this.errorCode = void 0;
          this.reason = void 0;
            ...
            if (event.data) {
              ...
              switch (receivedData.method) {
                ...
                case METHOD.ENTER_GAME:
                  (_crd && GameController === void 0 ? (_reportPossibleCrUseOfGameController({
                    error: Error()
                  }), GameController) : GameController).getInstance().resultPlayGame(receivedData);
                  break;
...
//# sourceMappingURL=0f891bcb8e7d9c8fe73b14e53ea96215be5feda2.js.map